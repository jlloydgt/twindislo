...
for i in xrange(ndisloiter):
    ...
    sim.plotsig(plotdim, disloscale=disloscale, res=plotres, pmax=maxstressplot, fname=destfolder+'step'+str(i+1)+'a.jpg')    
    ...
    #saving and plotting
    sim.plotsig(plotdim, disloscale=disloscale, res=plotres, pmax=maxstressplot, fname=destfolder+'step'+str(i+1)+'b.jpg')
